...
#Ver Tipo Insumo
#Este programa ver Tipo de Insumo
#
#
#Id: ver_tipo.php Ver. 1.0
#
# Control de Cambios:
...
<head>
  ...
  <title>Ver Tipo de Insumo  | AdminPanel | <?php echo $CFG->empresa;?></title>
...
?>
		...
		<section class="content-header">
		  <ol class="breadcrumb">
            ...
            <li class="active">Ver Tipo de Insumo</li>
		...
		<section class="content">
		  ...
		  <div class="box">
			<div class="box-header with-border">
			  <h2 class="box-title">Ver Tipo de Insumo</h2>
