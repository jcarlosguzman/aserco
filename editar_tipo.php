...
#Editar Tipos de Insumo
#Este programa editar tipos de insumo
#
#
#Id: editar_tipo.php Ver. 1.0
#
# Control de Cambios:
...
<head>
  ...
  <title>Editar Tipo de Insumo | AdminPanel | <?php echo $CFG->empresa;?></title>
...
<div id="wrapper">
	...
	?>
	  ...
	  <!-- Content Wrapper. Contiene el contenido-->
...
?>
		...
		<section class="content-header">
		  <ol class="breadcrumb">
			...
			<li><a href="<?php echo $CFG->url_admin?>/modulos/mod_tipos_insumo_v1.0/listado.php"><i class="fa fa-dashboard"></i> Listado Tipos de Insumo</a></li>
            <li class="active">Editar Tipo de Insumo</li>
		...
		<section class="content">
		  ...
		  <div class="box">
			<div class="box-header with-border">
			  <h2 class="box-title">Editar Tipo de Insumo</h2>
		   ...
		   if ($database->rowCount() >0) {
				   ...
				   // include the Zebra_Form class
					 ...
					 $form->show_all_error_messages(true);
				        ...
				        $obj = $form->add('text', 'txt_Tipo',$tipo_insumo,array('class' => 'form-control','style' => 'width:90% !important;','aria-required' => true));
						$obj->set_rule(array(
				        ...
				        $obj = $form->add('text', 'txt_Abreviatura',$abreviatura,array('class' => 'form-control','style' => 'width:90% !important;'));
					    ...
					    $obj = $form->add('radios', 'opt_Estado', array(
					        'A' =>  'Activo',
					        'I' =>  'Inactivo',
					    ),$estado,array('style' => 'width:30px;','aria-required' => true));
					    $obj->set_rule(array(
						...
						$form->add('button', 'btnback', 'Regresar ','button',array('class' =>'btn btn-success','onclick'=>'javascript:window.location = "'. $CFG->url_admin . '/modulos/mod_unidades_medida_v1.0/listado.php"'));
				        ...
				        if ($form->validate()) {
						  ...
						  $qry="update tb_tipo_insumo set
						   ...
						   $database->bind(':tipo_insumo',htmlspecialchars_decode(trim($_POST['txt_Tipo'])),PDO::PARAM_STR);
						   ...
						   if ($database->execute()) {
									...
									cambia_nodo($nodo,$tipo_contenido,$url);
